...
Apri la web app: http://127.0.0.1:5000/
...
presentare una spiegazione generale dei frattali;
dedicare una sezione specifica al Triangolo di Sierpinski;
permettere la generazione di frattali tramite parametri scelti dall'utente;
mostrare valori consigliati per ottenere immagini più nette e significative;
archiviare le immagini generate e renderle scaricabili in formato PNG;
documentare il lavoro di gruppo attraverso GitHub, con cronologia delle modifiche e contributi dei membri.
...
Clona la repository:
bashgit clone https://github.com/USER/progetto-frattale.git
cd progetto-frattale
Installa le dipendenze:
bashpip install -r requirements.txt
Avvia il server Flask:
bashpython app.py
Una volta avviato il server, apri il browser e vai su http://127.0.0.1:5000/. Per fermare il server premi Ctrl + C nel terminale.
